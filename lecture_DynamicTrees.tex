...
A warning: the $mincost(v)$ value \emph{not} the minimum cost on the path between $v$ and the path-root, it is the minimum cost in the treap-subtree, could be different.
